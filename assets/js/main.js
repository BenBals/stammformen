...
var add_lektion, add_lektionen, add_points, add_wrong, all_data, check, currQ, data, learn_wrongs, lektionen, li_listeners, newQ, random, remove_lektion, remove_wrong, save_wrongs, selection, wrongs;
...
$(function() {
  var i, key, val, _i, _len, _ref, _results;
  ...
  if (localStorage.wrongs === void 0) {
    ...
    for (_i = 0, _len = _ref.length; _i < _len; _i++) {
      i = _ref[_i];
      if (i !== '') {
        _results.push(wrongs.push(parseInt(i)));
      } else {
