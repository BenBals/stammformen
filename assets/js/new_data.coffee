data =
  ...
  2: [
    ...
    'fugere, fugio, fugi, -, fliehen, flüchten'
  ...
  3: [
    ...
    'considere, consido, consedi, consessum, sich hinsetzen'
    ...
    'monere, moneo, monui, monitum, erinnern, ermahnen, warnen'
  ...
  7: [
    ...
    'petere, peto, petivi, petitum, suchen, aufsuchen, angreifen, bitten, verlangen'
  ...
  8: [
    ...
    'consulere, consulo, consului, consultum, um Rat fragen, beraten, beschließen, sorgen für'
  ...
  9: [
    ...
    'reperire, reperio, repperi, repertum, finden, wiederfinden'
  ]
  10: [
    'apparere, appareo, apparui, -, erscheinen, sich zeigen'
    'consistere, consisto, constiti, -, stehen bleiben, anhalten, sich aufstellen'
    'credere, credo, credidi, creditum, glauben, anvertrauen'
    'custodire, custodio, custodivi, custoditum, bewachen'
    'decipere, decipio, decepi, deceptum, betrügen'
  ...
  12: [
    ...
    'inire, ineo, inii, initum hineingehen, anfangen'
    'interire, intereo, interio, interitum untergehen, umkommen'
    'ire, eo, ii, itum gehen'
    'praeterire, praetereo, praeterii, praeteritum vorbeigehen, übergehen'
    'regere, rego, rexi, rectum lenken, beherrschen'
    'volvere, volvo, volvi, volutum wälzen, rollen'
  ]
  13: [
    'arripere, arripio, arripui, arreptum ergreifen, packen'
    'aspicere, aspicio, aspexi, aspectum anschauen'
    'movere, moveo, movi, motum bewegen'
    'neglegere, neglego, neglexi, neglectum nicht beachten, vernachlässigen'
    'pendere, pendeo, pependi, - hängen, herabhängen'
    'perterrere, perterreo, perterrui, - heftig erschrecken'
  ...
  14: [
    ...
    'imponere, impono, imposui, impositum darauflegen, auferlegen'
  ...
  15: [
    ...
    'edere, edo, edidi, editum hervorbringen, bekannt geben'
    'imminere, immineo, -, - drohen, bevorstehen'
    'instituere, instituo, institui, institutum beginnen, einrichten, unterrichten'
    'parere, pario, peperi, partum hervorbringen, erwerben'
    'prohibere, prohibeo, prohibui, prohibitum abhalten, hindern'
    'ruere, ruo, rui, rutum eilen, stürmen, stürzen'
    'tendere, tendo, tetendi, tentum spannen, ausstrecken, sich anstrengen'
  ]
  16: [
    'carere, careo, carui, - entbehren, nicht haben'
  ...
  17: [
    ...
    'effugere, effugio, effugi, - entkommen'
    'invadere, invado, invasi, invasum eindringen, überfallen'
    'munire, munio, munivi, munitum schützen, befestigen'
    'resistere, resisto, restiti, - stehen bleiben, Widerstand leisten'
  ]
  18: [
    'abesse, absum, afui, - fehlen'
    'cedere, cedo, cessi, cessum gehen, nachgeben'
    'cernere, cerno, crevi, cretum wahrnehmen, erkennen, entscheiden'
    'descendere, descendo, descendi, - herabsteigen'
    'gerere, gero, gessi, gestum tragen, führen, ausführen'
    'patere, pateo, patui, - offen stehen, sich erstrecken'
    'providere, provideo, providi, provisum vorhersehen, sorgen für'
  ]
  19: [
    'constat, constitit m. Aci es steht fest, dass'
  ...
  20: [
    ...
    'convertere, converto, converti, conversum umwenden, verändern'
    'exstinguere, exstinguo, exstinxi, exstinctum auslöschen'
    'fungi, fungor, functus sum m. Abl. ausüben'
    'hortari, hortor, hortatus sum ermahnen, auffordern'
    'loqui, loquor, locutus sum sprechen, sagen'
    'oriri, orior, ortus sum sich erheben, entstehen'
    'sequi, sequor, secutus sum m. Akk. folgen'
    'solvere, solvo, solvi, solutum lösen, zahlen'
  ]
  21: [
    'arbitrari, arbitror, arbitratus sum glauben, meinen, halten für'
    'audere, audeo, ausus sum wagen'
    'expellere, expello, expuli, expulsum vertreiben, verbannen'
    'labi, labor, lapsus sum gleiten, fallen'
    'oboedire, oboedio, oboedivi, oboeditum gehorchen'
    'proficisci, proficiscor, profectus sum aufbrechen, reisen, marschieren'
    'solere, soleo, solitus sum gewohnt sein, gewöhnlich etw. tun'
    'suspicari, suspicor, suspicatus sum vermuten, einen Verdacht haben'
  ]
  22: [
    'cavere, caveo, cavi, cautum m. Akk. sich hüten'
    'circumdare, circumdo, circumdedi, circumdatum herumlegen, umgeben'
    ...
    'perire, pereo, perii, - umkommen, zugrunde gehen'
    ...
    'statuere, statuo, statui, statutum aufstellen, festsetzen, beschließen'
    'traicere, traicio, traieci, traiectum hinüberbringen, überqueren'
  ]
  23: [
    ...
    'egere, egeo, egui, - m. Abl. brauchen, nötig haben'
    'mori, morior, mortuus sum sterben'
  ]
  24: [
    'adhibere, adhibeo, adhibui, adhibitum hinwenden, anwenden, hinzuziehen'
    'cogere, cogo, coegi, coactum versammeln, zwingen'
    'efficere, efficio, effeci, effectum bewirken, herstellen, durchführen'
    'exire, exeo, exii, exitum herausgehen, weggehen'
    'iungere, iungo, iunxi, iunctum verbinden, anschließen'
    'morari, moror, moratus sum sich aufhalten, zögern'
    'nocere, noceo, nocui, nocitum Unheil anrichten, schaden'
    'parcere, parco, peperci, - m. Dat. sparen, verschonen'
    'pati, patior, passus sum leiden, ertragen, zulassen'
    'poscere, posco, poposci, - fordern, verlangen'
    'praestare, praesto, praestiti, - übertreffen, leisten, zeigen'
    'subicere, subicio, subieci, subiectum darunter legen, unterwerfen'
  ]
  25: [
    'adire, adeo, adii, aditum m. Akk. herantreten, bitten'
    'aggredi, aggredior, aggressus sum angreifen, herangehen'
    'censere, censeo, censui, censum meinen, einschätzen, beschließen'
    'concurrere, concurro, concurri, concursum zusammenlaufen, zusammenstoßen'
    'dissentire, dissentio, dissensi, dissensum anderer Meinung sein, nicht übereinstimmen'
    'disserere, dissero, disserui, dissertum sprechen, darlegen'
    'fateri, fateor, fassus sum bekennen, eingestehen'
    'mentiri, mentior, mentitus sum lügen'
    'nescire, nescio, nescivi, - nicht wissen'
    'obicere, obicio, obieci, obiectum vorwerfen, entgegenwerfen'
    'sentire, sentio, sensi, sensum fühlen, wahrnehmen, meinen'
    'versari, versor, versatus sum sich aufhalten, sich mit etw. beschäftigen'
  ]
  26: [
    'consentire, consentio, consensi, consensum übereinstimmen, zustimmen'
    ...
    'evenire, evenio, eveni, eventum herauskommen, sich ereignen'
    'instare, insto, institi, - m. Dat. bedrängen, bevorstehen'
    'invidere, invideo, invidi, invisum m. Dat. beneiden, Böses wollen'
    'studere, studeo, studui, - m. Dat. sich bemühen um, sich geistig betätigen'
    'uti, utor, usus sum m. Abl. benutzen, gebrauchen'
  ]
  27: [
    'cognoscere, cognosco, cognovi, cognitum kennen lernen, erkennen, erfahren'
    ...
    'fingere, fingo, finxi, fictum gestalten, formen, sich ausdenken'
    'frui, fruor, fruitus sum m. Abl. genießen'
    'imitari, imitor, imitatus sum nachahmen'
    'occurrere, occurro, occurri, occursum begegnen, entgegentreten'
    'perdere, perdo, perdidi, perditum verlieren, zugrunde richten'
    'praecipere, praecipio, praecepi, praeceptum vorschreiben, lehren'
  ]
  28: [
    'decet, decuit es gehört sich'
    'discere, disco, didici, - lernen, erfahren'
    'eripere, eripio, eripui, ereptum entreißen, herausreißen'
    'nasci, nascor, natus sum geboren werden, entstehen'
    'novisse, novi, notum wissen, kennen'
    'praeesse, praesum,praefui, - m. Dat leiten, verwalten'
    'precari, precor, precatus sum beten, bitten, wünschen'
    'rumpere, rumpo, rupi, ruptum zerbrechen, zerreißen'
  ]
  29: [
    'adipisci, adipiscor, adeptus sum erlangen'
    'augere, augeo, auxi, auctum vermehren, vergrößern'
    'conari, conor, conatus sum versuchen'
    'concedere, concedo, concessi, concessum nachgeben, zugestehen'
    'conficere, conficio, confeci, confectum herstellen, beenden'
    'dimittere, dimitto, dimisi, dimissum aufgeben, entlassen'
    'iacere, iacio, ieci, iactum werfen'
    'ingredi, ingredior, ingressus sum hineingehen, betreten'
    'interesse, intersum, interfui, - m. Dat. dazwischen sein, teilnehmen'
    'obstare, obsto, obstiti, - entgegenstehen, hinderlich sein'
    'praemittere, praemitto, praemisi, praemissum vorausschicken'
  ]
  30: [
    'ardere, ardeo, arsi, - brennen'
    'avertere, averto, averti, aversum abwenden, abwehren'
    'componere, compono, composui, compositum zusammenstellen, ordnen'
    ...
    'ferre, fero, tuli, latum tragen, ertragen, berichten'
    'inferre, infero, intuli, illatum hineintragen'
    'offerre, offero, obtuli, oblatum anbieten'
    'perferre, perfero, pertuli, perlatum durchführen, ertragen, berichten'
    'perspicere, perspicio, perspexi, perspectum durchschauen, erkennen'
    'praeferre, praefero, praetuli, praelatum vorziehen, vorantragen'
    'referre, refero, rettuli, relatum zurückbringen, berichten'
    'servire, servio, servivi, servitum dienen'
  ]
  31: [
    'adicere, adicio, adieci, adiectum hinzufügen'
    'appetere, appeto, appetivi, appetitum haben wollen, erstreben, angreifen'
    'committere, committo, commisi, commissum veranstalten, begehen, anvertrauen'
    'finire, finio, finivi, finitum beenden'
    'implere, impleo, implevi, impletum anfüllen, ausfüllen'
    'malle, malo, malui, - lieber wollen'
    'nolle, nolo, nolui, - nicht wollen'
    'oblivisci, obliviscor, oblitus sum m. Gen vergessen'
    'opprimere, opprimo, oppressi, oppressum unterdrücken, überfallen'
    'reducere, reduco, reduxi, reductum zurückführen, zurückziehen'
    'suscipere, suscipio, suscepi, susceptum übernehmen, unternehmen'
    'tollere, tollo, sustuli, sublatum hochheben, aufheben, beseitigen'
  ]
  32: [
    'assequi, assequor, assecutus sum erreichen'
    'complere, compleo, complevi, completum ausfüllen, erfüllen'
    'conferre, confero, contuli, collatum zusammenbringen, vergleichen, beitragen'
    'contingere, contingo, contigi, contactum berühren, zuteil werden'
    'discedere, discedo, discessi, discessum auseinander gehen, weggehen'
    'excipere, excipio, excepi, exceptum aufnehmen, eine Ausnahme machen'
    'fieri, fio, factus sum geschehen, gemacht werden'
    'laedere, laedo, laesi, laesum verletzen, beleidigen'
    'noscere, nosco, novi, notum kennen lernen, erkennen'
    'queri, queror, questus sum klagen, sich beschweren'
    'reverti, revertor, reverti, reversum zurückkehren'
    'suadere, suadeo, suasi, suasum m. Dat. überreden, raten'
    'tueri, tueor, tutatus sum anschauen, beschützen'
    'ulcisci, ulciscor, ultus sum rächen, strafen'
  ]
  33: [
    'coercere, coerceo, coercui, coercitum zusammenhalten, zügeln'
    'deducere, deduco, deduxi, deductum hinführen, wegführen'
    'flectere, flecto, flexi, flexum beugen, lenken, umstimmen'
    'flere, fleo, flevi, fletum weinen, beklagen'
    'potiri, potior, potitus sum m. Gen./Abl. erlangen'
  ...
  34: [
    'accendere, accendo, accendi, accensum anzünden'
    'addere, addo, addidi, additum hinzufügen'
    'auferre, aufero, abstuli, ablatum wegtragen, entfernen'
    'deligere, deligo, delegi, delectum auswählen'
    'diripere, diripio, diripui, direptum zerstören, plündern'
    'miscere, misceo, miscui, mixtum mischen'
    'niti, nitor, nisus sum sich anstrengen, sich stützen'
  ...
  35: [
    ...
    'fundere, fundo, fudi, fusum gießen, vertreiben'
  ...
  36: [
    ...
    'pudet me, puduit me ich schäme mich'
  ...
  37: [
    ...
    'intendere, intendo, intendi, intentum spannen, richten, beabsichtigen'
    'pertinere, pertineo, pertinui, - sich erstrecken, sich beziehen'
    'tribuere, tribuo, tribui, tributum zuteilen'
  ]
  38: [
    'adiungere, adiungo, adiunxi, adiunctum anfügen'
    'admittere, admitto, admisi, admissum zulassen'
    'consuescere, consuesco, consuevi, consuetum sich gewöhnen'
    'deferre, defero, detuli, delatum übertragen, mitteilen'
    'disponere, dispono, disposui, dispositum einrichten, ordnen'
    'possidere, possideo, possedi, possessum besitzen'
    'succedere, succedo, successi, successum nachfolgen, gelingen'
  ]
  39: [
    'abstinere, abstineo, abstinui, abstentum fern halten, „sich enthalten“'
    'bibere, bibo, bibi, - trinken'
    'contemnere, contemno, contempsi, contemptum nicht beachten, geringschätzen'
    'excedere, excedo, excessi, excessum hinausgehen, weggehen'
    'exigere, exigo, exegi, exactum hinaustreiben, vollenden, fordern'
    'ignoscere, ignosco, ignovi, ignotum verzeihen'
    'impedire, impedio, impedivi, impeditum hindern, verhindern'
    'inducere, induco, induxi, inductum hineinführen, verleiten'
    'offendere, offendo, offendi, offensum verletzen, beleidigen'
  ...
  40: [
    'continere, contineo, continui, contentum festhalten, umfassen, enthalten'
    'decedere, decedo, decessi, decessum weggehen, ausweichen'
    'deficere, deficio, defeci, defectum fehlen, schwinden'
    'deserere, desero, deserui, desertum verlassen, im Stich lassen'
    'egredi, egredior, egressus sum hinausgehen'
    'gignere, gigno, genui, genitum hervorbringen, zeugen, gebären'
    'nancisci, nanciscor, nactus sum bekommen, antreffen'
    'obtinere, obtineo, obtinui, obtentum im Besitz haben, festhalten'
    'praetermittere, praetermitto, praetermisi, praetermissum, wvorbeigehen lassen, übergehen'
    'requirere, requiro, requisivi, requisitum erforschen, aufsuchen, verlangen'
    'transferre, transfero, transtuli, translatum hinüberbringen, übertragen'
    'transire, transeo, transii, transitum hinübergehen, vorbeigehen'
  ]
